            ...
            <div className='container my-4'>
                <div className="card border-0 shadow">
                    <div className="card-body">
                        <h3 className='mb-4'>2/4</h3>
                        <h5>What was your favorite subject in college ? How do you think it will help in your career ?</h5>
                        <h6>Hint : Tell us about like DBMS, Operating System, Networking etc.</h6>
                        <hr />
